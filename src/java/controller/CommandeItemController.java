...
import static bean.Commande_.reference;
...
@ManagedBean(name = "commandeItemController")
@SessionScoped
public class CommandeItemController implements Serializable {
    ...
    /*public void  getCommandeItems(String reference){
       getSelected().setItems(ejbFacade.findByCommande(reference));
